...
if __name__ == "__main__":
    ...
    # 第4步，在图形界面上设定标签
    l = tk.Label(window, text='实验三 基本离散信号', bg='white', font=('Arial', 12), width=30, height=2)
    ...
    b4 = tk.Button(window, text='y[n] = e^[n/5]', font=('Arial', 12), width=10, height=1, command=draw_e)
